...
import startModule from '../../../img/startModule.png';
import stopModule from '../../../img/stopModule.png';
          ...
          <form className="form-horizontal">
            <fieldset className="scheduler-border">
              ...
              <section>
                ...
                <img src={(startIcon)} className="help-page-images" alt="Add-On manager homepage" /><br /><br />
                ...
                <img src={(stopIcon)} className="help-page-images" alt="Add-On manager homepage" /><br /><br />
                <p><strong>The Delete button </strong></p>
                <img src={(deleteAddon)} className="help-page-images" alt="Add-On manager homepage" /><br /><br />
                <p><strong>You can delete an installed addon by clicking the Delete Button.</strong></p> 
                <img src={(startModule)} className="help-page-images" alt="Add-On manager homepage" /><br /><br />
                <p><strong>You can start an addon by clicking the Start Button.</strong></p> 
                <img src={(stopModule)} className="help-page-images" alt="Add-On manager homepage" /><br /><br />
                <p><strong>You can stop an addon by clicking the Stop Button.</strong></p> 
